...
export const Selection = {
  of, clear, toggle, collapseToLast,
  cloneSet, normalizeIds, isEmptyInternal, // never called outside this file
} as const
```
RIGHT:
```ts
// cloneSet, normalizeIds, isEmptyInternal stay unexported module-local fns
export const Selection = { of, clear, toggle, collapseToLast } as const
```
