...
while (true) {
  ...
  catch (e) { log(e); continue; } // keeps a corrupt process alive on a poisoned bridge message
}
```
RIGHT:
```ts
...
// supervision — bridge reconnect, a process manager — is the recovery layer, not code
```
