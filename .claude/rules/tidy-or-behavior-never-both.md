...
WRONG:
```
commit: "rename walk->buildNode, extract nonSlotProps, fix childCount to include nested slots"
```
RIGHT:
```
commit: "tidy: rename walk->buildNode, extract nonSlotProps"
commit: "fix: count nested-slot children in childCount"
```
