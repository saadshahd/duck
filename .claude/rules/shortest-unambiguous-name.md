...
WRONG:
```ts
function mergePatternIntoComponentData(data: ComponentData, pattern: SectionPattern): MergeResult {}
```
RIGHT:
```ts
// in module `merge`
function merge(data: ComponentData, pattern: SectionPattern): MergeResult {}
```
