...
/** Frozen pattern contract for the morph suite: a container (Card/Stack) offers
 *  the applicable patterns; a Grid (collection) offers only quick variants; a
 *  lone Text (body) offers neither. */
